const CACHE='six-arts-shell-v12';
const SHELL=['/','/index.html','/app.js?v=20260911-12','/style.css?v=20260911-12','/base.css','/catalog.json','/manifest.webmanifest','/icon-192.png','/icon-512.png'];
